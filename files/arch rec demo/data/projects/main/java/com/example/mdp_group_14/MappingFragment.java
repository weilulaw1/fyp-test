...
public class MappingFragment extends Fragment {
    ...
    Button updateButton;
    ImageButton resetMapBtn, saveMapObstacle, loadMapObstacle, stmResetBtn;
    ...
    public View onCreateView(
        ...
        stmResetBtn = root.findViewById(R.id.resetBtn2);
...
//                }
        ...
        stmResetBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                showLog("Clicked stmResetBtn");
                showToast("sending <XXXXX>.....");
                Home.printMessage("message", "<XXXXX>");
            }
        });
        ...
        resetMapBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Home.printMessage("message","CLEAR");
                gridMap.resetMap();
